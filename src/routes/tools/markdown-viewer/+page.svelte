<script lang="ts">
	...
	import { markdownToHtml, exampleMarkdown, exampleMarkdown2 } from '$lib/core/markdown';
...
<div class="mb-4 flex h-screen">
	<section class="flex-1 pr-4">
		<header class="flex justify-between mb-6">
			<h1 class="text-xl font-bold block">View Markdown</h1>
		...
		<CodeEditor class="h-[500px]!" language="markdown" bind:value={input} />
	</section>
