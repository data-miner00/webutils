<script lang="ts">
	import { Album, ArrowBigRight, Clipboard, EllipsisVertical, Trash2 } from '@lucide/svelte';
...
<div class="grid h-full grid-cols-2 gap-4 px-4 py-6">
	<section class="flex flex-1 flex-col overflow-hidden">
		...
		<CodeEditor class="flex-1" language="sql" bind:value={input} />
	</section>
	...
	<section class="flex flex-1 flex-col overflow-hidden">
		...
		<CodeEditor class="flex-1" language="sql" value={output} readonly />
	</section>
</div>
