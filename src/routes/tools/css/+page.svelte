<script lang="ts">
	...
	import { exampleFormatCss, exampleFormatCss2, formatCss } from '$lib/core/format-css';
...
<div class="grid h-full grid-cols-2 gap-4 px-4 py-6">
	<section class="flex flex-1 flex-col overflow-hidden">
		<header class="mb-6 flex justify-between">
			<h1 class="block text-xl font-bold">Format CSS</h1>
		...
		<CodeEditor class="flex-1" language="css" bind:value={input} />
	</section>
	...
	<section class="flex flex-1 flex-col overflow-hidden">
		...
		<CodeEditor class="flex-1" language="css" value={output} readonly />
	</section>
</div>
