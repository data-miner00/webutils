<script lang="ts">
	...
	import { exampleYaml, jsonToYaml, yamlToJson } from '$lib/core/yaml';
...
<div class="grid h-full grid-cols-2 gap-4 px-4 py-6">
	<section class="flex flex-1 flex-col overflow-hidden">
		<header class="mb-6 flex justify-between">
			<h1 class="block text-xl font-bold">YAML to JSON Converter</h1>
		...
		<CodeEditor class="flex-1" language="yaml" bind:value={input} />
	</section>
